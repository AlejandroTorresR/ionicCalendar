...
export var ION_CALENDAR_CONTROL_VALUE_ACCESSOR = {
...
export var IonCalendarPeriod = (function () {
    function IonCalendarPeriod() {
    }
    return IonCalendarPeriod;
}());
export var IonCalendarChange = (function () {
    function IonCalendarChange() {
    }
    return IonCalendarChange;
}());
export var IonCalendarEntry = (function () {
...
export var IonCalendar = (function () {
    ...
    IonCalendar = __decorate([
        Component({selector: 'ion-calendar',
...
export var ION_CALENDAR_DIRECTIVES = [IonCalendar];
export var IonCalendarModule = (function () {
