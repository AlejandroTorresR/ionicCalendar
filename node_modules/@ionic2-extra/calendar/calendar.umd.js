(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('ionic-angular'), require('@angular/forms'), require('rxjs/Observable'), require('moment')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'ionic-angular', '@angular/forms', 'rxjs/Observable', 'moment'], factory) :
    (factory((global.md = global.md || {}, global.md.calendar = global.md.calendar || {}),global.ng.core,global.ng.common,global.ing,global.ng.forms,global.Rx,global.moment));
}(this, (function (exports,_angular_core,_angular_common,ionicAngular,_angular_forms,rxjs_Observable,moment) { 'use strict';
